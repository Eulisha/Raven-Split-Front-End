...
const API_GET_GROUP_MEMBERS = `${API_HOST}/api/group-members/`
...
export default {API_HOST, API_GET_GROUP_MEMBERS, API_GET_DEBTS, API_GET_DEBT_DETAILS, API_GET_BALANCES, API_POST_DEBT, API_UPDATE_DEBT, API_DELETE_DEBT}
